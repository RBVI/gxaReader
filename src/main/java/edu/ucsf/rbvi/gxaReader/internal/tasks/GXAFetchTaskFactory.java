...
public class GXAFetchTaskFactory extends AbstractTaskFactory {
	final GXAManager gxaManager;

	public GXAFetchTaskFactory(final GXAManager gxaManager) {
		super();
	...
	public TaskIterator createTaskIterator() {
		...
		ti.append(new GXAFetchTask(gxaManager));
		return ti;
	}
