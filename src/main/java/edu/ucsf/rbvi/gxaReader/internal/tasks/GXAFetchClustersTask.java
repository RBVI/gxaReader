...
public class GXAFetchClustersTask extends AbstractTask {
	final GXAManager gxaManager;

	@Tunable(description="Experiment to fetch clusters for")
	public ListSingleSelection<GXAExperiment> experiment = null;

	public GXAFetchClustersTask(final GXAManager gxaManager) {
	...
	@ProvidesTitle
	public String getTitle() {return "GXAFetchClusters";}
}
